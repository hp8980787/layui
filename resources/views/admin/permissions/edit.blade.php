<!doctype html>
<html lang="en">
@include('admin.layouts.__header',['title'=>'修改权限'])
    ...
    <div class="mainBox">
        <div class="main-container">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="url" value="{{ $permission->url }}" lay-verify="" class="layui-input">
                </div>
            </div>
        </div>
        <div class="bottom">
...
<script>
    layui.use(['form', 'jquery'], function () {
        let $ = layui.jquery;
        let form = layui.form;
        let UPDATE_PATH = '{{ route('admin.permissions.update') }}';
